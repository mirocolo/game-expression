...
import com.snowcattle.game.expression.impl.AddExpression;
import com.snowcattle.game.expression.impl.BinaryOperationExpression;
import com.snowcattle.game.expression.impl.DivideExpression;
import com.snowcattle.game.expression.impl.ModExpression;
import com.snowcattle.game.expression.impl.MultipleExpression;
import com.snowcattle.game.expression.impl.ParamExpression;
import com.snowcattle.game.expression.impl.StaticExpression;
import com.snowcattle.game.expression.impl.SubtractExpression;
...
public class ExpressionUtil {
	...
	private static final List<Character> OPERATORS =
			Arrays.asList(ADD, SUBTRACT, MULTIPLE, DIVIDE,
					MOD, LEFT_PARENTHESIS, RIGHT_PARENTHESIS, VARIABLE);

	private static final List<String> VALID_OPERATORS =
			Arrays.asList(String.valueOf(ADD), String.valueOf(SUBTRACT),
	...
	private static Expression buildExpression(LinkedList<String> operators) throws Exception {
		...
		while (operators.peek() != null) {
			...
			//解析变量占位符
			if (Objects.equals(operator, VARIABLE_STRING)) {
				if (left == null) {
